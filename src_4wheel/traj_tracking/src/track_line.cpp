...
//  moveit_msgs::DisplayTrajectory display_trajectory;
  ...
  file.open("/home/ybe/ROS/hexapod_moveit/src/traj_tracking/data/track_line.csv",std::ios::out);
  ...
  while(ros::ok())
  {
    ...
    // 关节空间规划
    end_eff_trans(1) = (end_eff_trans(1) - rel_pos_y - end_eff_trans(0) * sin(rel_yaw)) / cos(rel_yaw);
